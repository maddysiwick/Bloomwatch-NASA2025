...
tem01=pandas.read_csv('Temperature data/2023temp/tavg-202301-cty-scaled.csv')
tem02=pandas.read_csv('Temperature data/2023temp/tavg-202302-cty-scaled.csv')
tem03=pandas.read_csv('Temperature data/2023temp/tavg-202303-cty-scaled.csv')
tem04=pandas.read_csv('Temperature data/2023temp/tavg-202304-cty-scaled.csv')
tem05=pandas.read_csv('Temperature data/2023temp/tavg-202305-cty-scaled.csv')
tem06=pandas.read_csv('Temperature data/2023temp/tavg-202306-cty-scaled.csv')
tem07=pandas.read_csv('Temperature data/2023temp/tavg-202307-cty-scaled.csv')
tem08=pandas.read_csv('Temperature data/2023temp/tavg-202308-cty-scaled.csv')
tem09=pandas.read_csv('Temperature data/2023temp/tavg-202309-cty-scaled.csv')
tem10=pandas.read_csv('Temperature data/2023temp/tavg-202310-cty-scaled.csv')
tem11=pandas.read_csv('Temperature data/2023temp/tavg-202311-cty-scaled.csv')
tem12=pandas.read_csv('Temperature data/2023temp/tavg-202312-cty-scaled.csv')
