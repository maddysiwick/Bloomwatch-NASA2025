...
csv01=pandas.read_csv('Rainfall data/cnty/prcp-202301-cty-scaled.csv')
csv02=pandas.read_csv('Rainfall data/cnty/prcp-202302-cty-scaled.csv')
csv03=pandas.read_csv('Rainfall data/cnty/prcp-202303-cty-scaled.csv')
csv04=pandas.read_csv('Rainfall data/cnty/prcp-202304-cty-scaled.csv')
csv05=pandas.read_csv('Rainfall data/cnty/prcp-202305-cty-scaled.csv')
csv06=pandas.read_csv('Rainfall data/cnty/prcp-202306-cty-scaled.csv')
csv07=pandas.read_csv('Rainfall data/cnty/prcp-202307-cty-scaled.csv')
csv08=pandas.read_csv('Rainfall data/cnty/prcp-202308-cty-scaled.csv')
csv09=pandas.read_csv('Rainfall data/cnty/prcp-202309-cty-scaled.csv')
csv10=pandas.read_csv('Rainfall data/cnty/prcp-202310-cty-scaled.csv')
csv11=pandas.read_csv('Rainfall data/cnty/prcp-202311-cty-scaled.csv')
csv12=pandas.read_csv('Rainfall data/cnty/prcp-202312-cty-scaled.csv')
