...
tem01_21=pandas.read_csv('Temperature data/2021temp/tavg-202101-cty-scaled.csv')
tem02_21=pandas.read_csv('Temperature data/2021temp/tavg-202102-cty-scaled.csv')
tem03_21=pandas.read_csv('Temperature data/2021temp/tavg-202103-cty-scaled.csv')
tem04_21=pandas.read_csv('Temperature data/2021temp/tavg-202104-cty-scaled.csv')
tem05_21=pandas.read_csv('Temperature data/2021temp/tavg-202105-cty-scaled.csv')
tem06_21=pandas.read_csv('Temperature data/2021temp/tavg-202106-cty-scaled.csv')
tem07_21=pandas.read_csv('Temperature data/2021temp/tavg-202107-cty-scaled.csv')
tem08_21=pandas.read_csv('Temperature data/2021temp/tavg-202108-cty-scaled.csv')
tem09_21=pandas.read_csv('Temperature data/2021temp/tavg-202109-cty-scaled.csv')
tem10_21=pandas.read_csv('Temperature data/2021temp/tavg-202110-cty-scaled.csv')
tem11_21=pandas.read_csv('Temperature data/2021temp/tavg-202111-cty-scaled.csv')
tem12_21=pandas.read_csv('Temperature data/2021temp/tavg-202112-cty-scaled.csv')
